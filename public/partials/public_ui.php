...
if (!function_exists('pcf_pick_sample_image_urls_from_raw')) {
    ...
    {
        $images = [];
        foreach (['thumbnail', 'thumbnails', 'sampleimage', 'sampleImage', 'sample_image'] as $dugaImageKey) {
            pcf_collect_sample_image_urls_from_value($raw[$dugaImageKey] ?? null, $images);
        }
