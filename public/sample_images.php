...
$images = [];
if (is_array($decoded) && function_exists('pcf_pick_sample_image_urls_from_raw')) {
    $images = pcf_pick_sample_image_urls_from_raw($decoded);
}
if ($images === [] && is_array($decoded) && isset($decoded['sampleImageURL'])) {
