 ...
 *
 * Examples:
 * - /pinkclub-duga/public/index.php                => /pinkclub-duga
 * - /pinkclub-duga/admin/index.php                 => /pinkclub-duga
 */
 ...
 * subdirectory (e.g. `/pinkclub-duga/public/`). In that case infer the base
 ...
 * and we detected the app is running under a subdirectory (e.g. /pinkclub-duga),
